    ...
    <footer id="contact" className="bg-foreground text-background">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand */}
          <div>
            <img src={logoIesc} alt="IESC" className="h-16 w-auto mb-4 rounded bg-background p-1" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm text-background/70">
                ...
                <a href="https://www.iesc-cg.net" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors">www.iesc-cg.net</a>
              </li>
            </ul>
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/institutiesc" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-background/10 flex items-center justify-center hover:bg-gold transition-colors">
                <Facebook size={16} />
              </a>
              <a href="https://www.tiktok.com/@iesc_universite?_r=1&_t=ZS-94vQwjUwwPY" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-background/10 flex items-center justify-center hover:bg-gold transition-colors">
