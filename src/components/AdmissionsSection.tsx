        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className={`bg-primary rounded-lg p-8 shadow-md card-hover relative overflow-hidden transition-all duration-500 ${isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95"}`} style={{ transitionDelay: "350ms" }}>
            ...
            <div className="relative z-10">
              ...
              <div className="text-5xl font-heading font-bold text-gold mb-2">300.000</div>
              ...
              <a href="#contact" className="inline-flex w-full justify-center items-center px-6 py-3 bg-gold text-gold-foreground font-semibold rounded-md hover:brightness-110 transition-all">
                Postuler maintenant
              </a>
            </div>
          </div>
